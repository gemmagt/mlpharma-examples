...
My research has required me to work with high-dimensional, noisy, and incomplete data (stellar spectra, interferometric observations, large photometric catalogs), which maps directly onto the challenges of clinical data, genomics, and biomedical imaging. I have experience testing and benchmarking ML approaches: from classical methods (clustering, Bayesian inference, dimensionality reduction) to neural networks, and building robust, reusable pipelines with version control and clear documentation standards.
